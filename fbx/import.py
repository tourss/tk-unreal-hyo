...
# import data 
fbx_import_data = unreal.FbxSkeletalMeshImportData()
# fbx_import_data.combine_meshes = True
# fbx_import_data.remove_degenerates = True
...
if Path(source_path).exists():
    ...
    task.destination_name = Path(source_path).stem  # 파일 이름을 자산 이름으로 사용
